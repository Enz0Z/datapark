...
import me.datapark.DGTCamerasActivity;
import me.datapark.GasStationsActivity;
    ...
    public static void onOptionsItemSelected(Context context, MenuItem item) {
        switch (item.getItemId()) {
            case R.id.dgt_cameras:
                startActivity(context, new Intent(context, DGTCamerasActivity.class), null);
                break;
            case R.id.gas_stations:
                startActivity(context, new Intent(context, GasStationsActivity.class), null);
                break;
            case R.id.profile:
